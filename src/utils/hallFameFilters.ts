...
export function filterHallFameGrouped<T extends { player_class?: string | null; position?: number }>(
...
export function filterHallFameTop5<T extends { player_class?: string | null; position?: number }>(
  rows: T[],
): T[] {
  return rows
